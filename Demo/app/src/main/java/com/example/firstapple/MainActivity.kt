...
//            it.onComplete()
    ...
    fun concatTest() {
        ...
        Observable.concat(getCacheOb(), getNetOb())
    ...
    fun test(a: String?) {
        Observable.create<String> { }.`as`(
            AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(this, Lifecycle.Event.ON_DESTROY))
        )
            .subscribe({
